...
namespace Razix
{
    ...
    Graphics::Mesh* Graphics::CreatePrimative(PrimitiveType type)
    {
        ...
        case Graphics::PrimitiveType::File:
            Razix_LOG_WARN("Trying to create primitive of type File");
            return nullptr;
        }

        Razix_LOG_ERROR("Primitive not supported");
        return nullptr;
    };
