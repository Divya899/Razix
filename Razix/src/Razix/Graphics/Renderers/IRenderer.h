...
namespace Razix
{
    ...
    namespace Graphics
    {
        ...
        public:
            ...
            {
                Razix_ASSERT(width != 0 && height != 0, "Width or Height 0!");
        ...
        protected:
            ...
            Ref<Razix::Graphics::RenderPass> m_RenderPass;
            Ref<Razix::Graphics::Pipeline> m_Pipeline;
