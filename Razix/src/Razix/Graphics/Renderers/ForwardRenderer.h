...
namespace Razix
{
    ...
    namespace Graphics
    {
        ...
        class Razix_EXPORT ForwardRenderer : public IRenderer
        {
        public:
            ...
            {
                Razix::Maths::Matrix4 proj;
                Razix::Maths::Matrix4 view;
            };

            struct UniformBufferModel
            {
                Razix::Maths::Matrix4* model;
            };
        ...
        private:
            ...
            std::vector<Razix::Graphics::CommandBuffer*> m_CommandBuffers;
