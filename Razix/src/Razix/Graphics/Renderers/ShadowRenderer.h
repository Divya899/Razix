...
namespace Razix
{
    ...
    namespace Graphics
    {
        ...
        class Razix_EXPORT ShadowRenderer : public IRenderer
        {
        public:
            ...
            {
                Razix::Maths::Matrix4 projView[SHADOWMAP_MAX];
            };
            ...
            const Razix::Maths::Matrix4& GetLightView() const { return m_LightMatrix; }
