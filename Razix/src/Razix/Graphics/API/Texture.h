...
namespace Razix
{
    namespace Graphics
    {
        ...
        class Razix_EXPORT Texture2D : public Texture
        {
        public:
        ...
        class Razix_EXPORT TextureCube : public Texture
        {
        protected:
        ...
        class Razix_EXPORT TextureDepth : public Texture
        {
        public:
        ...
        class Razix_EXPORT TextureDepthArray : public Texture
        {
        public:
