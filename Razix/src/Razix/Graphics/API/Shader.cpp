...
namespace Razix
{
    namespace Graphics
    {
        ...
        {
            Razix_ASSERT(CreateFunc, "No Shader Create Function");
            return CreateFunc(filepath);
        }

        ShaderDataType Shader::SPIRVTypeToRazixDataType(const spirv_cross::SPIRType type)
        {
            ...
            Razix_LOG_WARN("Unknown spirv type!");
