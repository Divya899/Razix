...
namespace Razix
{
    namespace Graphics
    {
        ...
        TextureFormat Texture::BitsToTextureFormat(uint32_t bits)
        {
            ...
            default:
                Razix_ASSERT(false, "[Texture] Unsupported image bit-depth! ({0})", bits);
                return TextureFormat::RGB8;
            }
        }
        ...
        {
            Razix_ASSERT(CreateFunc, "No Texture2D Create Function");
        ...
        {
            Razix_ASSERT(CreateFromSourceFunc, "No Texture2D Create Function");
        ...
        {
            Razix_ASSERT(CreateFromFileFunc, "No Texture2D Create Function");
        ...
        {
            Razix_ASSERT(CreateFunc, "No TextureCube Create Function");
        ...
        {
            Razix_ASSERT(CreateFromFileFunc, "No TextureCube Create Function");
        ...
        {
            Razix_ASSERT(CreateFromFilesFunc, "No TextureCube Create Function");
        ...
        {
            Razix_ASSERT(CreateFromVCrossFunc, "No TextureCube Create Function");
        ...
        {
            Razix_ASSERT(CreateFunc, "No TextureDepth Create Function");
        ...
        {
            Razix_ASSERT(CreateFunc, "No TextureDepthArray Create Function");
