...
#include "Physics/RazixPhysicsEngine/RigidBody3D.h"
#include "Physics/RazixPhysicsEngine/SpringConstraint.h"
#include "Physics/RazixPhysicsEngine/WeldConstraint.h"
#include "Physics/RazixPhysicsEngine/DistanceConstraint.h"
#include "Physics/RazixPhysicsEngine/AxisConstraint.h"
...
namespace Razix
{
    ...
    class Razix_EXPORT Physics3DComponent
    {
    public:
        Physics3DComponent();
