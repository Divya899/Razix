...
namespace Razix
{
    namespace WindowsKeyCodes
    {
        ...
        inline Razix::InputCode::Key WindowsKeyToRazix(uint32_t key)
        {
            static std::map<uint32_t, Razix::InputCode::Key> keyMap = {
                { KEYBOARD_A, Razix::InputCode::Key::A },
                { KEYBOARD_B, Razix::InputCode::Key::B },
                { KEYBOARD_C, Razix::InputCode::Key::C },
                { KEYBOARD_D, Razix::InputCode::Key::D },
                { KEYBOARD_E, Razix::InputCode::Key::E },
                { KEYBOARD_F, Razix::InputCode::Key::F },
                { KEYBOARD_G, Razix::InputCode::Key::G },
                { KEYBOARD_H, Razix::InputCode::Key::H },
                { KEYBOARD_I, Razix::InputCode::Key::I },
                { KEYBOARD_J, Razix::InputCode::Key::J },
                { KEYBOARD_K, Razix::InputCode::Key::K },
                { KEYBOARD_L, Razix::InputCode::Key::L },
                { KEYBOARD_M, Razix::InputCode::Key::M },
                { KEYBOARD_N, Razix::InputCode::Key::N },
                { KEYBOARD_O, Razix::InputCode::Key::O },
                { KEYBOARD_P, Razix::InputCode::Key::P },
                { KEYBOARD_Q, Razix::InputCode::Key::Q },
                { KEYBOARD_R, Razix::InputCode::Key::R },
                { KEYBOARD_S, Razix::InputCode::Key::S },
                { KEYBOARD_T, Razix::InputCode::Key::T },
                { KEYBOARD_U, Razix::InputCode::Key::U },
                { KEYBOARD_V, Razix::InputCode::Key::V },
                { KEYBOARD_W, Razix::InputCode::Key::W },
                { KEYBOARD_X, Razix::InputCode::Key::X },
                { KEYBOARD_Y, Razix::InputCode::Key::Y },
                { KEYBOARD_Z, Razix::InputCode::Key::Z },

                { KEYBOARD_0, Razix::InputCode::Key::D0 },
                { KEYBOARD_1, Razix::InputCode::Key::D1 },
                { KEYBOARD_2, Razix::InputCode::Key::D2 },
                { KEYBOARD_3, Razix::InputCode::Key::D3 },
                { KEYBOARD_4, Razix::InputCode::Key::D4 },
                { KEYBOARD_5, Razix::InputCode::Key::D5 },
                { KEYBOARD_6, Razix::InputCode::Key::D6 },
                { KEYBOARD_7, Razix::InputCode::Key::D7 },
                { KEYBOARD_8, Razix::InputCode::Key::D8 },
                { KEYBOARD_9, Razix::InputCode::Key::D9 },

                { KEYBOARD_SUBTRACT, Razix::InputCode::Key::Minus },
                { KEYBOARD_DELETE, Razix::InputCode::Key::Delete },
                { KEYBOARD_SPACE, Razix::InputCode::Key::Space },
                { KEYBOARD_LEFT, Razix::InputCode::Key::Left },
                { KEYBOARD_RIGHT, Razix::InputCode::Key::Right },
                { KEYBOARD_UP, Razix::InputCode::Key::Up },
                { KEYBOARD_DOWN, Razix::InputCode::Key::Down },
                { KEYBOARD_LSHIFT, Razix::InputCode::Key::LeftShift },
                { KEYBOARD_RSHIFT, Razix::InputCode::Key::RightShift },
                { KEYBOARD_LCONTROL, Razix::InputCode::Key::LeftControl },
                { KEYBOARD_RCONTROL, Razix::InputCode::Key::RightControl },
                { KEYBOARD_LWIN, Razix::InputCode::Key::LeftSuper },
                { KEYBOARD_RWIN, Razix::InputCode::Key::RightSuper },
                { KEYBOARD_LMENU, Razix::InputCode::Key::Menu },
                { KEYBOARD_ESCAPE, Razix::InputCode::Key::Escape },
                { KEYBOARD_ADD, Razix::InputCode::Key::Equal },
                { KEYBOARD_BACK, Razix::InputCode::Key::Backspace },
                { KEYBOARD_RETURN, Razix::InputCode::Key::Enter },
                { KEYBOARD_COMMA, Razix::InputCode::Key::Comma }
            };
