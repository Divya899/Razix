...
namespace Razix
{
    namespace Graphics
    {
        ...
        {
            Razix_PROFILE_FUNCTION();
            Razix_ASSERT(m_Primary, "BeginRecording() called from a secondary command buffer!");
        ...
        {
            Razix_PROFILE_FUNCTION();
            Razix_ASSERT(!m_Primary, "BeginRecordingSecondary() called from a primary command buffer!");
            m_State = CommandBufferState::Recording;
        ...
        {
            Razix_PROFILE_FUNCTION();
            Razix_ASSERT(m_Primary, "Used Execute on secondary command buffer!");
            Razix_ASSERT(m_State == CommandBufferState::Ended, "CommandBuffer executed before ended recording");
        ...
        {
            Razix_PROFILE_FUNCTION();
            Razix_ASSERT(!m_Primary, "Used ExecuteSecondary on primary command buffer!");
            m_State = CommandBufferState::Submitted;
