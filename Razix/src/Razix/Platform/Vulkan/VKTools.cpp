...
namespace Razix
{
    namespace Graphics
    {
            ...
            uint32_t mipLevels)
        {
            ...
            {
                Razix_LOG_CRITICAL("unsupported layout transition!");
            }
...
#undef STR
        ...
        VkFormat VKTools::FormatToVK(Razix::Graphics::Format format)
        {
            switch(format)
            {
            case Razix::Graphics::Format::R32G32B32A32_FLOAT:
                return VkFormat::VK_FORMAT_R32G32B32A32_SFLOAT;
            case Razix::Graphics::Format::R32G32B32_FLOAT:
                return VkFormat::VK_FORMAT_R32G32B32_SFLOAT;
            case Razix::Graphics::Format::R32G32_FLOAT:
                return VkFormat::VK_FORMAT_R32G32_SFLOAT;
            case Razix::Graphics::Format::R32_FLOAT:
                return VkFormat::VK_FORMAT_R32_SFLOAT;
            case Razix::Graphics::Format::R32G32B32A32_UINT:
                return VkFormat::VK_FORMAT_R32G32B32A32_UINT;
            case Razix::Graphics::Format::R32G32B32_UINT:
                return VkFormat::VK_FORMAT_R32G32B32_UINT;
            case Razix::Graphics::Format::R32G32_UINT:
                return VkFormat::VK_FORMAT_R32G32_UINT;
            case Razix::Graphics::Format::R32_UINT:
                return VkFormat::VK_FORMAT_R32_UINT;
            case Razix::Graphics::Format::R8_UINT:
                return VkFormat::VK_FORMAT_R8_UINT;
            case Razix::Graphics::Format::R32G32B32A32_INT:
                return VkFormat::VK_FORMAT_R32G32B32A32_SINT;
            case Razix::Graphics::Format::R32G32B32_INT:
                return VkFormat::VK_FORMAT_R32G32B32_SINT;
            case Razix::Graphics::Format::R32G32_INT:
                return VkFormat::VK_FORMAT_R32G32_SINT;
            case Razix::Graphics::Format::R32_INT:
        ...
        VkSamplerAddressMode VKTools::TextureWrapToVK(const TextureWrap wrap)
        {
            ...
            default:
                Razix_LOG_CRITICAL("[Texture] Unsupported wrap type!");
                return VK_SAMPLER_ADDRESS_MODE_CLAMP_TO_EDGE;
            }
        }
        ...
        VkFilter VKTools::TextureFilterToVK(const TextureFilter filter)
        {
            ...
            case TextureFilter::NONE:
                return VK_FILTER_LINEAR;
            default:
                Razix_LOG_CRITICAL("[Texture] Unsupported TextureFilter type!");
                return VK_FILTER_LINEAR;
            }
        }
        ...
        VkFormat VKTools::TextureFormatToVK(const TextureFormat format, bool srgb)
        {
            if(srgb)
            {
                ...
                default:
                    Razix_LOG_CRITICAL("[Texture] Unsupported image bit-depth!");
                    return VK_FORMAT_R8G8B8A8_SRGB;
                }
            }
            else
        ...
        VkShaderStageFlagBits VKTools::ShaderTypeToVK(const ShaderType& shaderName)
        {
            ...
            default:
                Razix_LOG_CRITICAL("Unknown Shader Type");
                return VK_SHADER_STAGE_VERTEX_BIT;
            }
        }

        VkPolygonMode VKTools::PolygonModeToVk(Razix::Graphics::PolygonMode mode)
        {
            switch(mode)
            {
            ...
            case Graphics::PolygonMode::POINT:
                ...
                break;
            default:
                Razix_LOG_CRITICAL("Unknown Polygon Mode");
                return VK_POLYGON_MODE_FILL;
                break;
            }
        }

        VkPrimitiveTopology VKTools::DrawTypeToVk(Razix::Graphics::DrawType type)
        {
            switch(type)
            {
            ...
            case DrawType::POINT:
                ...
                break;
            default:
                Razix_LOG_CRITICAL("Unknown Draw Type");
                return VK_PRIMITIVE_TOPOLOGY_TRIANGLE_LIST;
                break;
            }
        }
        ...
        VkPresentModeKHR VKTools::ChoosePresentMode(const std::vector<VkPresentModeKHR>& supportedModes, bool vsync)
        {
            ...
            if(vsync)
            {
                ...
                {
                    Razix_LOG_ERROR("Failed to find supported presentation mode.");
                }
            }
            else
            {
