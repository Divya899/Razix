...
namespace Razix
{
    namespace Graphics
    {
        uint32_t GLTools::TextureFormatToGL(const TextureFormat format, bool srgb)
        {
            ...
            default:
                Razix_ASSERT(false, "[Texture] Unsupported TextureFormat");
                return 0;
            }
        }
        ...
        uint32_t GLTools::TextureWrapToGL(const TextureWrap wrap)
        {
            ...
            default:
                Razix_ASSERT(false, "[Texture] Unsupported TextureWrap");
                return 0;
            }
        }
        ...
        uint32_t GLTools::TextureFormatToInternalFormat(uint32_t format)
        {
            ...
            default:
                Razix_ASSERT(false, "[Texture] Unsupported Texture Format");
                return 0;
            }
        }
        ...
        uint32_t GLTools::StencilTypeToGL(const StencilType type)
        {
            ...
            case StencilType::ALWAYS:
                return GL_ALWAYS;
            default:
                Razix_ASSERT(false, "Unsupported StencilType");
                return 0;
            }
        }
        ...
        uint32_t GLTools::DataTypeToGL(DataType dataType)
        {
            ...
            default:
                Razix_LOG_ERROR("Unsupported DataType");
                break;
            }
            return 0;
        }
        ...
        uint32_t GLTools::DrawTypeToGL(DrawType drawType)
        {
            ...
            case DrawType::TRIANGLE:
                return GL_TRIANGLES;
            default:
                Razix_LOG_ERROR("Unsupported DrawType");
                break;
            }
            return 0;
        }
