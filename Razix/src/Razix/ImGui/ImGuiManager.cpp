...
namespace Razix
{
    ...
    void ImGuiManager::OnInit()
    {
        ...
        Razix_LOG_INFO("ImGui Version : {0}", IMGUI_VERSION);
#ifdef IMGUI_USER_CONFIG
        Razix_LOG_INFO("ImConfig File : {0}", std::string(IMGUI_USER_CONFIG));
#endif
    ...
    int RazixMouseButtonToImGui(Razix::InputCode::MouseKey key)
    {
        switch(key)
        {
        case Razix::InputCode::MouseKey::ButtonLeft:
            return 0;
        case Razix::InputCode::MouseKey::ButtonRight:
            return 1;
        case Razix::InputCode::MouseKey::ButtonMiddle:
            return 2;
        default:
            return 4;
        }
    ...
    {
        ImGuiIO& io = ImGui::GetIO();
        io.MouseDown[RazixMouseButtonToImGui(e.GetMouseButton())] = true;
    ...
    {
        ImGuiIO& io = ImGui::GetIO();
        io.MouseDown[RazixMouseButtonToImGui(e.GetMouseButton())] = false;
    ...
    bool ImGuiManager::OnKeyPressedEvent(KeyPressedEvent& e)
    {
        ...
        io.KeyCtrl = io.KeysDown[(int)Razix::InputCode::Key::LeftControl] || io.KeysDown[(int)Razix::InputCode::Key::RightControl];
        io.KeyShift = io.KeysDown[(int)Razix::InputCode::Key::LeftShift] || io.KeysDown[(int)Razix::InputCode::Key::RightShift];
        io.KeyAlt = io.KeysDown[(int)Razix::InputCode::Key::LeftAlt] || io.KeysDown[(int)Razix::InputCode::Key::RightAlt];

#ifdef _WIN32
        io.KeySuper = false;
#else
        io.KeySuper = io.KeysDown[(int)Razix::InputCode::Key::LeftSuper] || io.KeysDown[(int)Razix::InputCode::Key::RightSuper];
#endif
    ...
    void ImGuiManager::SetImGuiKeyCodes()
    {
        ...
        io.KeyMap[ImGuiKey_Tab] = (int)Razix::InputCode::Key::Tab;
        io.KeyMap[ImGuiKey_LeftArrow] = (int)Razix::InputCode::Key::Left;
        io.KeyMap[ImGuiKey_RightArrow] = (int)Razix::InputCode::Key::Right;
        io.KeyMap[ImGuiKey_UpArrow] = (int)Razix::InputCode::Key::Up;
        io.KeyMap[ImGuiKey_DownArrow] = (int)Razix::InputCode::Key::Down;
        io.KeyMap[ImGuiKey_PageUp] = (int)Razix::InputCode::Key::PageUp;
        io.KeyMap[ImGuiKey_PageDown] = (int)Razix::InputCode::Key::PageDown;
        io.KeyMap[ImGuiKey_Home] = (int)Razix::InputCode::Key::Home;
        io.KeyMap[ImGuiKey_End] = (int)Razix::InputCode::Key::End;
        io.KeyMap[ImGuiKey_Insert] = (int)Razix::InputCode::Key::Insert;
        io.KeyMap[ImGuiKey_Delete] = (int)Razix::InputCode::Key::Delete;
        io.KeyMap[ImGuiKey_Backspace] = (int)Razix::InputCode::Key::Backspace;
        io.KeyMap[ImGuiKey_Space] = (int)Razix::InputCode::Key::Space;
        io.KeyMap[ImGuiKey_Enter] = (int)Razix::InputCode::Key::Enter;
        io.KeyMap[ImGuiKey_Escape] = (int)Razix::InputCode::Key::Escape;
        io.KeyMap[ImGuiKey_A] = (int)Razix::InputCode::Key::A;
        io.KeyMap[ImGuiKey_C] = (int)Razix::InputCode::Key::C;
        io.KeyMap[ImGuiKey_V] = (int)Razix::InputCode::Key::V;
        io.KeyMap[ImGuiKey_X] = (int)Razix::InputCode::Key::X;
        io.KeyMap[ImGuiKey_Y] = (int)Razix::InputCode::Key::Y;
        io.KeyMap[ImGuiKey_Z] = (int)Razix::InputCode::Key::Z;
