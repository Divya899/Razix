...
namespace Razix
{
    ...
    struct Razix_EXPORT CollisionEdge
    {
    ...
    class Razix_EXPORT CollisionShape
    {
    public:
        CollisionShape()
            : m_Type()
        ...
        {
            Razix_LOG_ERROR("Loading abstract CollisionShape");
        }

        template <class Archive>
        void save(Archive& archive) const
        {
            Razix_LOG_ERROR("Serialising abstract CollisionShape");
        }
