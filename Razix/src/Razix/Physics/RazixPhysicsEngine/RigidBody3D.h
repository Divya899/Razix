...
#include "Physics/RazixPhysicsEngine/HullCollisionShape.h"

#include "Maths/Maths.h"
#include <cereal/types/polymorphic.hpp>
#include <cereal/cereal.hpp>

CEREAL_REGISTER_TYPE(Razix::SphereCollisionShape);
CEREAL_REGISTER_TYPE(Razix::CuboidCollisionShape);
CEREAL_REGISTER_TYPE(Razix::PyramidCollisionShape);
CEREAL_REGISTER_TYPE(Razix::HullCollisionShape);

CEREAL_REGISTER_POLYMORPHIC_RELATION(Razix::CollisionShape, Razix::SphereCollisionShape);
CEREAL_REGISTER_POLYMORPHIC_RELATION(Razix::CollisionShape, Razix::CuboidCollisionShape);
CEREAL_REGISTER_POLYMORPHIC_RELATION(Razix::CollisionShape, Razix::PyramidCollisionShape);
CEREAL_REGISTER_POLYMORPHIC_RELATION(Razix::CollisionShape, Razix::HullCollisionShape);

namespace Razix
{
    class RazixPhysicsEngine;
    class Manifold;
    ...
    class Razix_EXPORT RigidBody3D : public RigidBody
    {
        friend class RazixPhysicsEngine;
    ...
    public:
        ...
        {
            Razix_ASSERT(v > 0, "Physics object mass <= 0");
            m_InvMass = 1.0f / v;
