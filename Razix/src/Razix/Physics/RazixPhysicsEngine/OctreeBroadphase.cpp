...
namespace Razix
{
        ...
        std::vector<CollisionPair>& collisionPairs)
    {
        ...
        {
            Razix_PROFILE_SCOPE("Reset nodes");
        ...
        for(uint32_t i = 0; i < objectCount; i++)
        {
            ...
            {
                Razix_PROFILE_SCOPE("Merge Bounding box and add Physics Object");
    ...
    void OctreeBroadphase::Divide(OctreeNode& division, const size_t iteration)
    {
        ...
        {
            Razix_PROFILE_SCOPE("Create Child");
            ...
            {
                Razix_PROFILE_SCOPE("PhysicsObject BB check");
