...
namespace Razix::Maths
{
    ...
    public:
        ...
        Razix::Maths::Matrix3 ToMatrix3() const
        {
            return Razix::Maths::Matrix3(
                m00_,
                m01_,
                m02_,
                m10_,
        ...
        bool Equals(const Matrix4& rhs, float eps = M_EPSILON) const
        {
            ...
            for(unsigned i = 0; i < 16; ++i)
            {
                if(!Razix::Maths::Equals(leftData[i], rightData[i], eps))
                    return false;
            }
        ...
        {
            return (
                Razix::Maths::IsNaN(m00_) || Razix::Maths::IsNaN(m01_) || Razix::Maths::IsNaN(m02_) || Razix::Maths::IsNaN(m03_) ||

                Razix::Maths::IsNaN(m10_) || Razix::Maths::IsNaN(m11_) || Razix::Maths::IsNaN(m12_) || Razix::Maths::IsNaN(m13_) ||

                Razix::Maths::IsNaN(m20_) || Razix::Maths::IsNaN(m21_) || Razix::Maths::IsNaN(m22_) || Razix::Maths::IsNaN(m23_) ||

                Razix::Maths::IsNaN(m30_) || Razix::Maths::IsNaN(m31_) || Razix::Maths::IsNaN(m32_) || Razix::Maths::IsNaN(m33_));
        }
        ...
        {
            return (
                Razix::Maths::IsInf(m00_) || Razix::Maths::IsInf(m01_) || Razix::Maths::IsInf(m02_) || Razix::Maths::IsInf(m03_) ||

                Razix::Maths::IsInf(m10_) || Razix::Maths::IsInf(m11_) || Razix::Maths::IsInf(m12_) || Razix::Maths::IsInf(m13_) ||

                Razix::Maths::IsInf(m20_) || Razix::Maths::IsInf(m21_) || Razix::Maths::IsInf(m22_) || Razix::Maths::IsInf(m23_) ||

                Razix::Maths::IsInf(m30_) || Razix::Maths::IsInf(m31_) || Razix::Maths::IsInf(m32_) || Razix::Maths::IsInf(m33_));
        }
