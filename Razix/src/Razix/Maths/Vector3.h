...
namespace Razix::Maths
{
    ...
    public:
        ...
        void Normalise()
        {
            ...
            if(!Razix::Maths::Equals(lenSquared, 1.0f) && lenSquared > 0.0f)
            {
        ...
        {
            return Razix::Maths::Abs(x * rhs.x) + Razix::Maths::Abs(y * rhs.y) + Razix::Maths::Abs(z * rhs.z);
        }
        ...
        Vector3 Abs() const { return Vector3(Razix::Maths::Abs(x), Razix::Maths::Abs(y), Razix::Maths::Abs(z)); }
        ...
        {
            return Razix::Maths::Equals(x, rhs.x, eps) && Razix::Maths::Equals(y, rhs.y, eps) && Razix::Maths::Equals(z, rhs.z, eps);
        }

        /// Returns the angle between this vector and another vector in degrees.
        float Angle(const Vector3& rhs) const { return Razix::Maths::Acos(DotProduct(rhs) / (Length() * rhs.Length())); }

        /// Return whether is NaN.
        bool IsNaN() const { return Razix::Maths::IsNaN(x) || Razix::Maths::IsNaN(y) || Razix::Maths::IsNaN(z); }

        /// Return whether is Inf.
        bool IsInf() const { return Razix::Maths::IsInf(x) || Razix::Maths::IsInf(y) || Razix::Maths::IsInf(z); }
...
{
    template <>
    struct hash<Razix::Maths::Vector3>
    {
        size_t operator()(const Razix::Maths::Vector3& x) const
        {
