...
namespace Razix::Maths
{
    ...
    public:
        ...
        {
            return Razix::Maths::Abs(x * rhs.x) + Razix::Maths::Abs(y * rhs.y) + Razix::Maths::Abs(z * rhs.z) + Razix::Maths::Abs(w * rhs.w);
        }
        ...
        Vector4 Abs() const { return Vector4(Razix::Maths::Abs(x), Razix::Maths::Abs(y), Razix::Maths::Abs(z), Razix::Maths::Abs(w)); }
        ...
        {
            return Razix::Maths::Equals(x, rhs.x, eps) && Razix::Maths::Equals(y, rhs.y, eps) && Razix::Maths::Equals(z, rhs.z, eps) && Razix::Maths::Equals(w, rhs.w, eps);
        }

        /// Return whether is NaN.
        bool IsNaN() const { return Razix::Maths::IsNaN(x) || Razix::Maths::IsNaN(y) || Razix::Maths::IsNaN(z) || Razix::Maths::IsNaN(w); }
...
{
    template <>
    struct hash<Razix::Maths::Vector4>
    {
        size_t operator()(const Razix::Maths::Vector4& x) const noexcept
        {
