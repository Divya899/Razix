...
namespace Razix::Maths
{
    ...
    public:
        ...
        Colour Abs() const { return Colour(Razix::Maths::Abs(r_), Razix::Maths::Abs(g_), Razix::Maths::Abs(b_), Razix::Maths::Abs(a_)); }

        /// Test for equality with another Colour with epsilon.
        bool Equals(const Colour& rhs, float eps = M_EPSILON) const
        {
            return Razix::Maths::Equals(r_, rhs.r_, eps)
                && Razix::Maths::Equals(g_, rhs.g_, eps)
                && Razix::Maths::Equals(b_, rhs.b_, eps)
                && Razix::Maths::Equals(a_, rhs.a_, eps);
        }
