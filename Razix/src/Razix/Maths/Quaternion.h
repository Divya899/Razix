...
namespace Razix::Maths
{
    ...
    public:
...
#if defined(Razix_SSE) && (!defined(_MSC_VER) || _MSC_VER >= 1700) /* Visual Studio 2012 and newer. VS2010 bug */
        {
        ...
        {
            return Razix::Maths::Equals(w, rhs.w, eps) && Razix::Maths::Equals(x, rhs.x, eps) && Razix::Maths::Equals(y, rhs.y, eps) && Razix::Maths::Equals(z, rhs.z, eps);
        }

        /// Return whether any element is NaN.
        bool IsNaN() const { return Razix::Maths::IsNaN(w) || Razix::Maths::IsNaN(x) || Razix::Maths::IsNaN(y) || Razix::Maths::IsNaN(z); }

        /// Return whether any element is Inf.
        bool IsInf() const { return Razix::Maths::IsInf(w) || Razix::Maths::IsInf(x) || Razix::Maths::IsInf(y) || Razix::Maths::IsInf(z); }
