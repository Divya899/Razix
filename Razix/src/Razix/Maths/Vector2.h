...
namespace Razix::Maths
{
    ...
    public:
        ...
        float AbsDotProduct(const Vector2& rhs) const { return Razix::Maths::Abs(x * rhs.x) + Razix::Maths::Abs(y * rhs.y); }
        ...
        Vector2 Abs() const { return Vector2(Razix::Maths::Abs(x), Razix::Maths::Abs(y)); }

        /// Linear interpolation with another vector.
        Vector2 Lerp(const Vector2& rhs, float t) const { return *this * (1.0f - t) + rhs * t; }

        /// Test for equality with another vector with epsilon.
        bool Equals(const Vector2& rhs, float eps = M_EPSILON) const { return Razix::Maths::Equals(x, rhs.x, eps) && Razix::Maths::Equals(y, rhs.y, eps); }

        /// Return whether is NaN.
        bool IsNaN() const { return Razix::Maths::IsNaN(x) || Razix::Maths::IsNaN(y); }
...
{
    template <>
    struct hash<Razix::Maths::Vector2>
    {
        size_t operator()(const Razix::Maths::Vector2& x) const
        {
